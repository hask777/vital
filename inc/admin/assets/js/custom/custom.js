jQuery(document).ready(function($){
   ...
   // Image uploader Header 1
	...
	var blogImage = new MediaUploader('#upload-blog-img', '#blog-input', '#blog_image_preview img');

	var servicesImage = new MediaUploader('#upload-services-img', '#services-input', '#services_image_preview img');

	var portfolioImage = new MediaUploader('#upload-portfolio-img', '#portfolio-input', '#potfolio_image_preview img');

    // var newsletterImage = new MediaUploader('#upload-footer-img', '#footer-input', '#footer_image_preview img');

    var footerImage = new MediaUploader('#upload-footer-img', '#footer-input', '#footer_image_preview img');
