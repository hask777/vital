...
function uza_add_admin_page(){
   ...
   // Add sub page
      ...
      // Archive page
      add_submenu_page('uza_main_page', 'Uza Archive', __('Категории', 'uza'), 'manage_options', 'uza_archive_page', 'uza_theme_create_archive_page');
...
// Create Metaboxes
add_action('admin_init', 'uza_admin_pages_metabox_init');
require_once 'inc/pages/metaboxes/metabox.php';
...
// Save page meta data in DB
add_action('save_post_page', 'uza_save_page_post_admin', 10, 3);
require_once 'inc/pages/page_post.php';

// Injection page meta data to filter
add_filter('the_content', 'uza_page_data_filter_content');
require_once 'inc/pages/page-data-filter.php';
